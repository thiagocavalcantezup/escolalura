...
public class AlunoRepository {
    ...
    public List<Aluno> encontrarPorGeolocalizacao(Aluno aluno) {
        abrirConexao();
        ...
        Point pontoReferencia = new Point(new Position(coordinates));

        MongoCursor<Aluno> resultado = alunos.find(
            Filters.nearSphere("contato", pontoReferencia, 2000.0, 0.0)
